...
#define FOX_CORE_WARN(...) ::FoxEngine::Log::GetFoxEngineLogger()->warn(__VA_ARGS__)
#define FOX_CORE_ERROR(...) ::FoxEngine::Log::GetFoxEngineLogger()->error(__VA_ARGS__)
#define FOX_CORE_FATAL(...) ::FoxEngine::Log::GetFoxEngineLogger()->fatal(__VA_ARGS__)
...
#define FOX_CLIENT_FATAL(...) ::FoxEngine::Log::GetClientLogger()->fatal(__VA_ARGS__)